...
public class Csv {
    ...
    /**
     * if true it tries to identify encoding from bom on inputStream
     * @param value
     * @return this
     */
    public Csv readBom(boolean value) { this.readBom = value; return this; }
    /**
     * if true tries to identify encoding with BOM and write it ti output stream
     * @param value
     * @return this
     */
    public Csv writeBom(boolean value) { this.writeBom = value; return this; }
